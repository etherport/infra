...
| [llm-camera-monitoring-scope-2026-08.md](planning/llm-camera-monitoring-scope-2026-08.md) | M158 scoping (investigation ✅ 2026-08-14) — verified camera inventory (face+LPR NVR-side, RTSP off, ~24d retention), webhook payload trace, P40/CUDA verdict + measured power/cost, operator direction |
| [llm-camera-monitoring-design-2026-08.md](planning/llm-camera-monitoring-design-2026-08.md) | 📋 M158 design draft — phased build: `lookout` service (Protect WS intake → LLM triage → ntfy/SES/postgres), HA correlation + NL history, event-triggered STT + vision; operator action list (RTSP enable, protect-tf→SOPS, firewall rule, vision spike) |
