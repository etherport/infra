...
| Storage VLAN | 210 (10.10.210.0/24) — dedicated Ceph network, added 2026-05-18. PVE mon on 10.10.210.41; K8s nodes on .50-.60 via `enp6s22` (MTU 9000). See [`docs/runbooks/ceph-vlan-migration.md`](../runbooks/ceph-vlan-migration.md). |
...
| Proxmox SDN | Named bridges per VLAN on PVE: `servers` (201), `clients` (202), `iot` (204), `security` (205), `vsan` (209), `guest` (206), `unifi` (212). Standalone VMs migrated to `bridge=servers` 2026-05-18. K8s VMs pending PR 5. See [`infra/terraform/proxmox/sdn/`](../../infra/terraform/proxmox/sdn/). |
