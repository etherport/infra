...
- **🟡 Resume RUNNING (2026-06-19 ~06:38):** `photos-export-resume.sh` (CLEANUP off) re-launched on hardened SMB; osxphotos skips the 10.2k already-exported and downloads+exports the remaining ~4k via PhotoKit, rebuilding the export DB. Monitored for progress/drops.
