...
| Network plugin | Calico | `inventory/group_vars/k8s_cluster/k8s-cluster.yml` |
| Pod CIDR | 10.233.64.0/18 | `inventory/group_vars/k8s_cluster/k8s-cluster.yml` |
| Service CIDR | 10.233.0.0/18 | `inventory/group_vars/k8s_cluster/k8s-cluster.yml` |
