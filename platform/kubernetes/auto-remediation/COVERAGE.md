...
- **WireGuard K8s pod** (`wireguard/wireguard`) — single replica, VRRP backup is vpn-fallback. The 2026-05-22 incident showed VRRP failover IS automatic but slow without preStop fixes.
