...
- **Secrets** (all SOPS):
  ...
  - `advisor-ssh-key` — Tier 3 SSH key (deployed to dns-fallback/vpn-fallback/vpn-aws; the former dns-aws instance was destroyed 2026-07, M110 — its DNS role lives on the vpn-aws edge box)
